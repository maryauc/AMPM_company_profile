<?php
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM aroundme_wedding where id = '$id'");
    ...
    <div class="container-fluid">
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title">Edit AroundMe Wedding Gallery Data</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <form method='POST' action='crud/update/update_aroundme-wedding.php' enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-10">
                            <!-- textarea -->
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label>Picture</label>
                                <br>
                                <img width="300px" src="dist/img/aroundme_wedding/<?php echo $view['picture']; ?>">
                                <br>
