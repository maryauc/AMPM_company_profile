<?php
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM subtitle where id = '$id'");
    ...
    <div class="container-fluid">
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title">Edit Subtitle Data - <?php echo $view['title']; ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <form method='POST' action='crud/update/update_subtitle.php'>
                    <div class="row">
                        <div class="col-sm-10">
                            <!-- textarea -->
